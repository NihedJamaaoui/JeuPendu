    ...
    public void initialize() {
        ...
        if (sessionManager.isLoggedIn()) {
            ...
            keyboardGrid.sceneProperty().addListener((obs, oldScene, newScene) -> {
                if (newScene != null && sessionManager.isLoggedIn()) {
        ...
        Platform.runLater(() -> {
            try {
                ...
                if (keyboardGrid.getScene() != null && keyboardGrid.getScene().getRoot() != null) {
                    ...
                    // More aggressive stylesheet cleanup
                    rootPane.getStylesheets().removeIf(s ->
                            s.contains("background") || s.contains("wallpaper") || s.contains("theme"));
                    ...
                    delay.setOnFinished(e -> {
                        ...
                        if (cssUrl != null) {
                            ...
                            if (!rootPane.getStylesheets().contains(externalForm)) {
                                rootPane.getStylesheets().add(externalForm);
                            }
                        } else {
                ...
                System.err.println("Error applying background: " + ex.getMessage());
                applyDefaultBackground();
            }
        });
    }
        ...
        Platform.runLater(() -> {
            try {
                if (keyboardGrid.getScene() != null && keyboardGrid.getScene().getRoot() != null) {
                    ...
                    // Apply default
                    URL defaultUrl = getClass().getResource("/resources/styles/default-wallpaper.css");
                    if (defaultUrl != null) {
